...
int disp_msghandle(struct BASE * this, message_t *msg)
{
	...
	//	LCD_Backlight_On();
		...
		switch (msg->wpara) {
		case KEY_UP:
			GUI_DispStringAt("UP", 60,40);
			break;
		case KEY_DOWN:
			GUI_DispStringAt("DOWN", 60,40);
			break;
		case KEY_LEFT:
			GUI_DispStringAt("LEFT", 60,40);
			break;
		case KEY_RIGHT:
			GUI_DispStringAt("RIGHT", 60,40);
			break;
		case KEY_ENTER:
			GUI_DispStringAt("FRONT", 60,40);
			break;
		case KEY_CANCEL:
			GUI_DispStringAt("BACK", 60,40);
			break;
		default:
			break;
		}
